...
| ------------- | ------------- | ------------- | ------------- |
| 1. | Atrast/izveidot cilvēka kaulu, muskuļu un orgānu modeļus | Sagatavot konceptuālo modeli. Sagatavot izstrādes vidi. Sagatavot bibliotēku saistības (dependencies). | Izstrādā mājaslapas pirmās lapas dizainu, pāreju uz izvēlēto anatomijas sadaļu.|
| 2. | Izveidot sarasktu/uzskatāmu materiālu ar iekļaujamajiem kauliem + 1/2 muskuļiem | Izveidot python failu un datubāžu sistēmu backend. Izveidot javascript failu un HTML failu frontend  |  Ievietot pagaidu informāciju mājaslapā, lai nodrošinātu, ka visas lapas ir saslēgtas.|
| 3. | Izveidot sarasktu/uzskatāmu materiālu ar iekļaujamajiem 1/2 muskuļiem + orgāniem|   Izveidot backend savienojumu ar serveri. Izmēģināt API saziņu ar serveri un pārbaudīt, vai no frontend var nosūtīt informāciju uz datubāzi  | Izmēģināt API saziņu ar serveri un pārbaudīt, vai no frontend var nosūtīt informāciju uz datubāzi|
| 4. | Ievietot cilvēka modeļus mājaslapā.| Izveidot sign up un log in funkcionalitāti: informācijas nosūtīšanu uz  backend un datubāzēm un informācijas pieprasīšanu no datubāzēm |  Izveidot log in sadaļu frontend|
| 5. | Novietot cilvēka daļu nosaukumus uz modeļiem tā, ka tie parādas, kad tiek aktivizēta funkcija “parādīt nosaukumus” (saprast, kā to darīt, uztaisīt muskuļu modelim šo funkciju) | Izveidot backend tā, lai var nomainīt paroli, ir saikne ar e-pastu un var atgūt aizmirstu paroli caur e-pastu. | Savienot log in frontend un backend|
| 6. | Turpināt novietot cilvēka daļu nosaukumus uz modeļiem tā, ka tie parādas, kad tiek aktivizēta funkcija “parādīt nosaukumus” (kaulu, orgānu modeļi) | Ievietot sarakstus ar iekļaujamajiem kauliem/muskuļiem datubāzē. |  Spēles loģistika, nodrošināt punktu skaitīšanas funkcijas|
| 7. | Novietot nospiežamās pogas uz cilvēka muskuļu, kaulu modeļiem. |  Izveidot algoritmu jautājuma ģenerēšanai un nodrošināt jautājuma sūtīšanu uz frontend | Pārvērst punktus procentos, izstrādāt ‘score’ saglabāšanu|
| 8. | Novietot nospiežamās pogas uz cilvēka orgānu modeļa. | Iveidot kodu ievadītās atbildes saņemšanai backend. Izveidot ievadītās atbildes pareizības pārbaudi un boolean pazeiz vai nepareizs vērtības nosūtīšanu uz frontend | Izveido Scoreboard dizainu|
| 9. | Mājas lapas dizains - pogas, nodaļas, krāsas -, lai viss labi izskatās. | Nodrošināt rezultātu saņemšanu backend un ievietošanu datubāzē  |  Pārbauda vai ir vienmērīga pāreja no jautājuma uz jautājumu, no sadaļas uz sadaļu. Pārliecinās, ka nav lielas dizaina maiņas vai pārmēru lēns domāšanas laiks|
